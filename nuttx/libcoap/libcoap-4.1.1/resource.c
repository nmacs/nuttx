...
#endif /* WITH_POSIX */
#if defined(WITH_CONTIKI) || defined(WITH_MEMB)
#include "memb.h"
...
#endif /* defined(WITH_CONTIKI) || defined(WITH_MEMB) */
...
coap_delete_resource(coap_context_t *context, coap_key_t key) {
...
#endif
#else /* !defined(WITH_POSIX) && !defined(WITH_LWIP) */
  /* delete registered attributes */
  ...
  memb_free(&resource_storage, resource);
#endif /* defined(WITH_POSIX) || defined(WITH_LWIP) */
